...
The first and most crucial part of this is having your artwork separated into different layers; each layer will be a different distance away from the "camera." Of course, this is easiest if the image was something like a digital painting with everything already nicely separated. In my case, however, the image I wanted to use was just one from the internet.
